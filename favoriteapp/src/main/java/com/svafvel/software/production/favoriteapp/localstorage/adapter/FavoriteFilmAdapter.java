package com.svafvel.software.production.favoriteapp.localstorage.adapter;
...
import com.svafvel.software.production.favoriteapp.DetailActivity;
...
public class FavoriteFilmAdapter extends RecyclerView.Adapter<FavoriteFilmAdapter.FavoriteFilmViewHolder> {
    ...
    private void prepare(int index, final FavoriteFilmViewHolder holder, final int position){
