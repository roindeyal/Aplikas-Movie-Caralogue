...
public class SearchViewModel extends ViewModel {
    ...
    public void setSearchFilm(final String film, Activity activity, String search){
        ...
        String url = "http://api.themoviedb.org/3/search/" + film + "?api_key=" + API_KEY + "&language=" +
                    activity.getResources().getString(R.string.localization) + "&query=" + search;
    ...
    public LiveData <ArrayList<FilmItems>> getSearchFilm(){
